...
func (u *itemUsecasae) CreateItem(pctx context.Context, req *item.CreateItemReq) (*item.ItemShowCase, error) {
...
func (u *itemUsecasae) FindOneItem(pctx context.Context, itemId string) (*item.ItemShowCase, error) {
...
func (u *itemUsecasae) FindManyItems(pctx context.Context, req *item.ItemSearchReq, basePaginateUrl string) (*models.PaginateRes, error) {
	...
	countItemsFilter = append(findItemsFilter, bson.E{"usage_status", true})
...
func (u *itemUsecasae) EditItem(pctx context.Context, itemId string, req *item.ItemUpdateReq) (*item.ItemShowCase, error) {
...
func (u *itemUsecasae) EnableOrDisableItem(pctx context.Context, itemId string) (bool, error) {
